...
const button = document.getElementsByClassName('handler__btn');
const bUtton = document.querySelector('.screen-btn');
const item1 = document.querySelectorAll('.other-items.number');
const item2 = document.querySelectorAll('.other-items.range');
